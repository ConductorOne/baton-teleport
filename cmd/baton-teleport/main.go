...
const (
	...
	teleportProxyAddress = "teleport-proxy-address"
	teleportKeyFile      = "teleport-key-file"
)

var (
	teleportKeyFileField = field.StringField(teleportKeyFile,
		field.WithRequired(true),
		field.WithDescription("Path to the teleport file generated by using the tctl admin tool. Example: \"auth.pem\"."))
	proxyAddressField = field.StringField(teleportProxyAddress,
		field.WithRequired(true),
...
func getConnector(ctx context.Context, cfg *viper.Viper) (types.ConnectorServer, error) {
	...
	cb, err := connector.New(ctx,
		cfg.GetString(teleportProxyAddress),
		cfg.GetString(teleportKeyFile),
	)
	if err != nil {
